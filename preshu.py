...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;97m********************************************\n\x1b[1;93m      AUTHER    :     Preshaa\n                    n\x1b[1;98m          Send id in messenger for approval\n\x1b[1;97m *******************************************\n'

def reg():
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;31;1mTake The Approval'
    print ''
    time.sleep(1)
    try:
    ...
    r = requests.get('https://raw.githubusercontent.com/pershaqueen1334/preshu/main/server.txt').text
    if to in r:
        ...
        print ''
        print ' \x1b[1;92mCopy token id and send to preshum'
        print ''
        print ' \x1b[1;92mYour id: ' + to
        print ''
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/kamala.puri.90')
        reg()
...
def reg2():
    ...
    print ''
    print ' \x1b[1;91mCopy and press enter , And Send Me On Facebook'
    print ''
    ...
    os.system('xdg-open https://www.facebook.com/kamala.puri.90')
    sav = open('/sdcard/.prshu.txt', 'w')
    sav.write(id)
    sav.close()
    raw_input('\x1b[1;92m Press enter to check Approval by Admin')
    reg()
